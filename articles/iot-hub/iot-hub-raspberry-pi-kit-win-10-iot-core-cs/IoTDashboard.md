...
You can also connect to the device using Windows PowerShell, SSH (need to start it first, [see here](https://developer.microsoft.com/en-us/windows/iot/docs/ssh)) and through File Explorer Remotely (Open Network Share).
